...
// Wait until all active plugins are loaded so WooCommerce is available
// regardless of the plugin load order. Otherwise the constructor exits early
// and [currency_switcher] remains unregistered and is shown as plain text.
