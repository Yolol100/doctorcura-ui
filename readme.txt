...
== Changelog ==
= 1.3.6 =
* Verkleint het witte deselectiekruisje naar 9 bij 9 pixels
* Gebruikt het compacte tweelaagse CSS-kruis met 8px tussenruimte en verticale uitlijning op 1px
...
* Publieke lost-passwordmeldingen zijn neutraal en bevestigen niet of een account bestaat
* Behoudt de server-side CHF/EUR currency switcher en de WooCommerce-afhankelijke bootstrap uit 1.3.1
